/**
 * SealGate Gateway badge - the central "SealGate" mark that anchors the
 * "policy enforced here" metaphor. Composed of a pulse ring + the full
 * SealGate logo, optionally with a label below.
 *
...
import { SealGateLogo } from './icons'
  ...
  return (
    <>
      <circle
        ...
        strokeWidth="1.5"
      />
      <SealGateLogo x={cx - w / 2} y={cy - h / 2} w={w} h={h} />
      {label !== undefined && (
        <text
          x={cx}
          y={cy + r + 15}
