...
export const AGENT_REGISTRY: Record<AgentId, AgentIconEntry> = {
  ...
  grok: {
    displayName: 'Grok',
    brandColor: '#000000',
    // Official Grok (xAI) mark. Two even-odd slashes at viewBox 0 0 1024 1024,
    // so it can't collapse into a single svgPath - it's a self-contained
    // customSvg like codex/devin/aider: a black rounded tile with the white
    // glyph, so it renders correctly on any surface including the
    // background-less Electron dialog icons. Padded viewBox (-160 -160 1344
    // 1344) centers the native 1024x1024 artwork with breathing room. Source:
    // svgl.app (grok-dark variant, white fill).
    customViewBox: '-160 -160 1344 1344',
    customSvg: [
      '<rect x="-160" y="-160" width="1344" height="1344" rx="180" fill="#000000"/>',
